...
[Documentation](../../../packages.md) / [@thermal-label/brother-ql-node](../README.md) / PrinterError

# Class: PrinterError

Defined in: packages/node/src/errors.ts:8
...
> **new PrinterError**(`message`, `errors`): `PrinterError`

Defined in: packages/node/src/errors.ts:9
...
Defined in: packages/node/src/errors.ts:11
