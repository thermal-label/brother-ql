...
[Documentation](../../../packages.md) / [@thermal-label/brother-ql-node](../README.md) / UnsupportedOperationError

# Class: UnsupportedOperationError

Defined in: packages/node/src/errors.ts:1
...
Defined in: packages/node/src/errors.ts:2
